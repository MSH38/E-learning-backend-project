...
@section('owner')
    ...
    @endsection
@section('content')
    <form method="get" action="{{route('getSubCategories',$subCategories[0]->category_id)}}">
    ...
    <div class="card">
        <div class="card card-dark">
            <div class="card-header">
                ...
                <h3 class="card-title">List SubCategories  of {{App\Models\Category::find($subCategories[0]->category_id)->name}}</h3>
                    @endif
            </div>
